 ...
 * 
 */
@WebServiceClient(name = "SayHelloService", targetNamespace = "http://service.sunny.org/", wsdlLocation = "http://192.168.20.157:9091/Service/SayHello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SAYHELLOSERVICE_QNAME = new QName("http://service.sunny.org/", "SayHelloService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://192.168.20.157:9091/Service/SayHello?wsdl");
    ...
    public SayHello getSayHelloPort() {
        return super.getPort(new QName("http://service.sunny.org/", "SayHelloPort"), SayHello.class);
    }
    ...
    public SayHello getSayHelloPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.sunny.org/", "SayHelloPort"), SayHello.class, features);
    }
